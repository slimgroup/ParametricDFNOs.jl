...
# # TODO: Train p = 4 with F64 to pass below tests.
# serial_1 = load(projectdir("weights", "DFNO_2D", "dtype=Float64_p=1_mt=4_mx=4_my=4_nblocks=1_nc_in=4_nc_lift=20_nc_mid=128_nc_out=1_nt_in=51_nt_out=51_nx=64_ny=64.jld2"))
