...
myanim[:save]("movies/DFNO_3D/$(filename[1:end-5])_z_slice_$(dim)³.mp4", bitrate=-1, extra_args=["-vcodec", "-pix_fmt", "yuv420p"])
...
myanim[:save]("movies/DFNO_3D/$(filename[1:end-5])_y_slice_$(dim)³.mp4", bitrate=-1, extra_args=["-vcodec", "-pix_fmt", "yuv420p"])
...
myanim[:save]("movies/DFNO_3D/$(filename[1:end-5])_x_slice_$(dim)³.mp4", bitrate=-1, extra_args=["-vcodec", "-pix_fmt", "yuv420p"])
